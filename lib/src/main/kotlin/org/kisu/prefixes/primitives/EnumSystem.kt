 ...
 *
 * This class uses reflection on the provided enum class to retrieve all prefix values, sort them by their natural
 * ordering, and expose common lookup operations. Concrete systems define which enum value is [canonical] because
 * different prefix algebra strategies use different base-prefix rules.
 *
