 ...
 *
 * This class expresses magnetic flux density as a combination of a [magnitude] and a [prefix], supporting values such as
 * milliteslas (mT), microteslas (µT), or kiloteslas (kT).
 *
 * Instances of this class are immutable and use [BigDecimal] for precision.
 */
class MagneticFluxDensity internal constructor(magnitude: BigDecimal, prefix: Metric = Metric.BASE) :
    Measure<Metric, MagneticFluxDensity>(magnitude, prefix, SYMBOL, ::MagneticFluxDensity) {
