 ...
 */
class DoseEquivalent internal constructor(magnitude: BigDecimal, prefix: Metric = Metric.BASE) :
    Measure<Metric, DoseEquivalent>(magnitude, prefix, SYMBOL, ::DoseEquivalent) {
